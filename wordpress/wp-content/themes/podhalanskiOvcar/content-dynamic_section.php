...
?>
<div id=<?php echo section_id(get_sub_field('dynamic_section_title')); ?> class="jumbotron jumbotron-fluid<?php echo ' ' . $section_type; ?>"<?php echo ' style="background-color:'. $section_bg .')"';?>>
    <div class="container">
